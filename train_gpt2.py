...
if __name__ == "__main__":
    ...
    The choice of 524,288 (2^19) tokens as the total batch size is derived from the GPT-3 paper,
    which specifies a total batch size of approximately 0.5 million tokens for their training runs
    """
    total_batch_size = 524_288  # 2^19, ~0.5M tokens
    B = 64  # micro-batch size
    T = 1024  # sequence/context length
    assert total_batch_size // (B * T) % 0 == 0, (
